...
describe("GET /digipet/rehome", () => {
    test("if the user doesn't have a digipet, it responds with a message explaining that a digipet can't be rehomed if the user doesn't have one", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup
