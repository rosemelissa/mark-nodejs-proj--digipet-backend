...
app.get("/instructions", (req, res) => {
    res.json({
        ...
        description: "You can check out your digipet's stats below, and do various actions after that with the buttons, for example walk, train, feed, ignore, hatch, and rehome.",
    });
});
